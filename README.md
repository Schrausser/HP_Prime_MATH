...
Mathematical and statistical applications for HP Prime (s. HP Inc., 2017), for an *overview* of the implemented methods and their *historical development* see `paper.md`, for the full function index see `func.md`, `func_tab.md`:
