...
(7) *Rank biserial* correlation coefficient $r_{bisR}$ or *rank biseral*, corresponding to the *effect size* for the *Mann–Whitney* $U$*-test* (Mann & Whitney, [1947](https://doi.org/10.1214/aoms/1177730491)).
...
(14) Coefficient of *multiple* correlation $R_{c,12}$, for $\hat R_{c,12}^2$ see Olkin & Pratt ([1958](https://doi.org/10.1214/aoms/1177706717)), with the *effect size* for *multiple* regression $f^2$ (Cohen, [1988](https://doi.org/10.4324/9780203771587), p. 410).
...
———. (1925). *Statistical Methods for Research Workers*. 1st ed. Edinburgh: Oliver; Boyd. [https://www.scirp.org/reference/referencespapers?referenceid=2056938](https://www.scirp.org/reference/referencespapers?referenceid=2056938)
...
Stigler, S. M. (1986). *The history of statistics: the measurement of uncertainty before 1900*. Cambridge, MA: Belknap Press of Harvard University Press. [https://www.scirp.org/reference/ReferencesPapers?ReferenceID=1973131](https://www.scirp.org/reference/ReferencesPapers?ReferenceID=1973131)
